  ...
  return (
    ...
    >
      {/* ── Background media ──────────────────────────── */}
        ...
        />
        <Image src={"https://res.cloudinary.com/dofyrwzop/image/upload/q_auto/f_auto/v1779719152/IMMOBILIER_zdlobk.png"} fill className="absolute inset-0 w-full h-full object-cover transition-opacity duration-700" alt="Actualite" />
