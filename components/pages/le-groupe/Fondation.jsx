      ...
      <div className="max-w-[1500px] mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            {/* Paragraph */}
            <p className="font-sans text-[13px] md:text-[15px] text-neutral-900 leading-[1.8] mb-12 max-w-[500px]">
            ...
            <div className="grid grid-cols-3 gap-4 max-w-[480px]">
              {[
                ...
                >
                  <p className="font-serif text-[19px] text-gold mb-1">{s.val}</p>
                  <p className="font-sans text-[9px] md:text-[10px] tracking-[0.15em] uppercase text-neutral-800 text-center">
                    {s.lbl}
                  </p>
                </motion.div>
              ))}
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <p className="font-sans text-[13px] text-neutral-900/70 leading-[1.8]">
            ...
            >
              <p className="font-sans text-[11px] tracking-[0.2em] font-semibold uppercase text-neutral-800 mb-6">
                Réalisations
              </p>
              ...
              <ul className="space-y-3 md:space-y-4">
                {REALISATIONS.map((item, i) => (
                  ...
                  >
                    <span className="flex-none mt-[8px] w-1 h-1 rounded-full bg-neutral-800" />
                    <span className="font-sans text-[13px] text-neutral-800 leading-relaxed">
                      {item}
                    </span>
                  </motion.li>
                ))}
