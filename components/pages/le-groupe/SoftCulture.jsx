...
function BookCard({ book, inView, index }) {
  ...
  const handleMouseEnter = useCallback(() => {
    const el = cardRef.current
    if(el) el.style.transition = "none" // Remove transition during mouse movement to prevent lag
    setHovered(true)
  }, [])
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* Subtle inner reflection/glow on hover */}
        <div 
...
export default function SoftCulture() {
  ...
  return (
    <section ref={ref} className="bg-black py-20 md:py-32 relative overflow-hidden" id="softculture" style={{
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="mt-2 shrink-0">
                <img 
                  ...
                  className="h-12 md:h-14 w-auto invert brightness-0 opacity-90" 
                />
              </div>

              {/* Titles & Text */}
              <div className="flex flex-col">
                <p className="font-sans text-[10px] md:text-[11px] font-semibold tracking-[0.2em] uppercase text-[#D4AF37] mb-4">
                  Mécénat Culturel
                </p>
                
                <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-normal leading-[1.2]">
                  <span className="text-white">SoftCulture — </span> <br></br>
