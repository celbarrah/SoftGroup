...
export default function ProcessGestion() {
  ...
  return (
    <section ref={ref} className="bg-white py-24 md:py-36 overflow-hidden" id="processus-gestion">
      <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-20">
        ...
        >
          ...
          <p className="font-sans text-[16px] text-neutral-500 mt-6 max-w-xl mx-auto leading-[1.9]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
          {STEPS.map((step, i) => (
            <motion.div
              ...
              className="relative border border-gray-100 p-8 group hover:border-gold/30 hover:shadow-md transition-all duration-400 bg-white"
            >
              ...
              <div className="mb-6">
                <span className="font-sans text-[9px] tracking-[0.35em] uppercase text-gold/50">{step.num}</span>
              </div>

              <div className="w-10 h-px bg-gold/25 mb-6" />

              <h3 className="font-serif text-xl text-neutral-800 font-light leading-[1.3] mb-4 group-hover:text-gold transition-colors duration-300">
                {step.title}
              </h3>
        ...
        <motion.div
          ...
          className="mt-12 border border-gray-100 bg-gray-50 p-8 max-w-2xl mx-auto text-center"
        >
          <p className="font-sans text-[15px] text-neutral-500 leading-[1.85] italic">
