...
export default function PropertyManagement() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#F5F3EF]" id="gestion">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[680px] lg:min-h-[760px]">
        ...
        <div className="relative overflow-hidden h-[420px] lg:h-auto order-2 lg:order-1">
          <motion.div style={{ y: bgY }} className="absolute inset-0 w-full h-[110%] -top-[5%]">
            <Image
          ...
          {/* <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#F5F3EF] opacity-50 hidden lg:block" /> */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#F5F3EF]/60 to-transparent lg:hidden" />
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center px-10 md:px-14 lg:px-16 xl:px-20 py-20 lg:py-24 relative z-10">
          ...
          <motion.h2
            ...
            className="font-serif text-3xl md:text-4xl lg:text-5xl text-neutral-800 font-light leading-[1.1] mb-8"
          >
            Property &amp; Facility
            <br />
          ...
          >
            ...
            au bon fonctionnement de vos actifs et infrastructures.
          </motion.p>
