...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    href: "/portefeuille",
    children: [
      { label: "Logistique & Industriel",      href: "/portefeuille#logistique"  },
      { label: "Résidentiel de Prestige",      href: "/portefeuille#residentiel" },
      { label: "Bureaux & Centres d'Affaires", href: "/portefeuille#bureaux"     },
      { label: "Commercial",                   href: "/portefeuille#retail"       },
      { label: "Terrains & Développements",    href: "/portefeuille#terrains"     },
    ],
  },
