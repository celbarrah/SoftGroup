...
export const alt         = "Softgroup Immobilier — L'Immobilier d'Excellence au Maroc"
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ color: "#fff", fontSize: 54, fontWeight: 300, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
          L&apos;Immobilier d&apos;Excellence
        </div>
        <div style={{ color: "#C4A55A", fontSize: 36, fontWeight: 300, fontStyle: "italic" }}>
          au Maroc
        </div>
      </div>
