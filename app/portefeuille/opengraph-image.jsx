...
export const alt         = "Portefeuille Immobilier — Softgroup Immobilier Maroc"
  ...
  return new ImageResponse(
    <div style={{ background: "#0A1018", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "56px 70px", position: "relative" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <span style={{ color: "#C4A55A", fontSize: 12, letterSpacing: "0.32em", textTransform: "uppercase", fontWeight: 700 }}>Portefeuille d&apos;actifs</span>
        <div style={{ width: 40, height: 2, background: "#C4A55A" }} />
        <div style={{ color: "#fff", fontSize: 52, fontWeight: 300, lineHeight: 1.1, letterSpacing: "-0.02em" }}>5 segments,</div>
        <div style={{ color: "#C4A55A", fontSize: 36, fontWeight: 300, fontStyle: "italic" }}>4 pôles économiques au Maroc</div>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", gap: 10 }}>
          {["Logistique", "Bureaux", "Résidentiel", "Retail", "Terrains"].map(s => (
