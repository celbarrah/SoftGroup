...
export const alt         = "Le Groupe — Softgroup Holding, un siècle d'excellence au Maroc"
  ...
  return new ImageResponse(
    <div style={{ background: "#0A1018", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "56px 70px", position: "relative" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <span style={{ color: "#C4A55A", fontSize: 12, letterSpacing: "0.32em", textTransform: "uppercase", fontWeight: 700 }}>Le Groupe</span>
        <div style={{ width: 40, height: 2, background: "#C4A55A" }} />
        <div style={{ color: "#fff", fontSize: 52, fontWeight: 300, lineHeight: 1.1, letterSpacing: "-0.02em" }}>Un siècle d&apos;excellence</div>
        <div style={{ color: "#C4A55A", fontSize: 28, fontWeight: 300, fontStyle: "italic" }}>au service du Maroc depuis 1918</div>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", gap: 10 }}>
          {["Textile", "Immobilier", "Fondation", "Culture"].map(s => (
