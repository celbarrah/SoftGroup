...
export const alt         = "Gestion & Valorisation — Property & Facility Management | Softgroup Immobilier"
  ...
  return new ImageResponse(
    <div style={{ background: "#0A1018", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "56px 70px", position: "relative" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <span style={{ color: "#C4A55A", fontSize: 12, letterSpacing: "0.32em", textTransform: "uppercase", fontWeight: 700 }}>Service après location</span>
        <div style={{ width: 40, height: 2, background: "#C4A55A" }} />
        <div style={{ color: "#fff", fontSize: 52, fontWeight: 300, lineHeight: 1.1, letterSpacing: "-0.02em" }}>Gestion &amp; Valorisation</div>
        <div style={{ color: "#C4A55A", fontSize: 28, fontWeight: 300, fontStyle: "italic" }}>Property &amp; Facility Management</div>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", gap: 10 }}>
          {["Property Management", "Facility Management", "Maintenance", "Sécurité"].map(s => (
